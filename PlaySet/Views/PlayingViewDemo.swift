//
//  PlayingViewDemo.swift
//  PlaySet
//
//  Created by Michael De La Cruz on 1/19/19.
...
@IBDesignable
class PlayingCardViewDemo: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        roundedRect.addClip()  // "add a path then addClip for striping?"
